...
namespace Rosu_Lucian_Lab11x.Data
{
    public class RestService : IRestService
    {
        ...
        readonly string RestUrl = "https://192.168.1.131:45455/swagger/index.html{0}";
        public List<ShopList> Items { get; private set; }
        public RestService()
        {
            Items = new List<ShopList>(); // Initialize Items to avoid CS8618 error
        ...
        public async Task<List<ShopList>> RefreshDataAsync()
        {
            ...
            try
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    var items = JsonConvert.DeserializeObject<List<ShopList>>(content);
                    if (items != null)
                    {
                        Items = items;
                    }
